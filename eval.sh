...
do
    ...
    --model_to_load "./output/full_${TASK}/best.pt" --no_transform --eval --consistent_only

    # Use category info
    python $ENTRY --model_name "full_${TASK}_cate" --mode both --task $TASK --batch_size 16 --device $DEVICE --max_iter $MAX_ITER \
    --model_to_load "./output/full_${TASK}_cate/best.pt" --no_transform --use_cate --eval --consistent_only
